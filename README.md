...
A identidade visual está sendo trabalhada para transmitir:
...
<p>
  ...
  <img src="https://raw.githubusercontent.com/devicons/devicon/master/icons/sass/sass-original.svg" width="30" /> SASS (SCSS)
</p>
  
Alguns elementos visuais e animações também foram **inspirados em criações do CodePen**, sendo **adaptados e otimizados** para atender ao estilo e identidade da Lavanderia Med Clean.
...
- [x] Estrutura HTML, CSS e SCSS base pronta  
...
- Aprimorar minhas habilidades em HTML, CSS, **SASS/SCSS** e JavaScript puros  
